...
document.write(`username: ${alice.fName}<br/>`)
...
const indexSeventySix = grades.findIndex((grade) => grade === 76 )
document.write(`indexSeventySix = ${indexSeventySix}<br/>`)
...
// const grades = [98,87,76,65,54,43,32,21]
document.write('<h2>List with an array </h2>')
document.write('<ul>')
document.write('<li>a = '+grades[0]+' </li>')
document.write('<li>b = '+grades[1]+' </li>')
document.write('<li>c = '+grades[2]+' </li>')
